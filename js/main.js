...
for(var i = 0; i < 8; i++) { 
	...
	for(var j = 0; j < 4; j++) {
		...
		new_bit.setAttribute("class", "btn btn-dark calculator-bit border border-dark button5"); 
...
function bitfield_update(argument) {
	...
	if(argument.value != "0") {
		argument.setAttribute("class", "btn btn-primary calculator-bit border border-dark button5");
	} else {
		argument.setAttribute("class", "btn btn-dark calculator-bit border border-dark button5"); 
	}
